  ...
  return (
    ...
    <div>
        ...
        <form className='max-w-xl px-5 space-y-3' onSubmit={onSubmit}>
            <TextField.Root defaultValue = {issue?.title} {...register("title", { required: true })} placeholder="Search the docs…"></TextField.Root>
            ...
            <Button type="submit" disabled={isSubmitting}>{issue ? 'Update Issue' : 'Add Issue'}{ }{isSubmitting && <Spinner />}</Button>
        </form>    
    </div>
    </>
  )
